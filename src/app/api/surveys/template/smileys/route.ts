...
export async function GET(req: NextRequest) {
  ...
  const leftLabel = req.nextUrl.searchParams.get("leftLabel");
  const rightLabel = req.nextUrl.searchParams.get("rightLabel");
  const commentMessage = req.nextUrl.searchParams.get("commentMessage");
  const buttonStyle = req.nextUrl.searchParams.get("buttonStyle");
